...
export default function HotActivitiesPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold tracking-tight">热门活动</h1>
        <Badge className="bg-red-500">{activities.length}</Badge>
      </div>
              ...
              <div className="px-6 pb-4 flex justify-between">
                ...
                <div className="space-x-2">
                  ...
                  <Button
                    ...
                    disabled={
                      hasJoined(activity) || isBlacklisted() || activity.participants.length >= activity.maxParticipants
                    }
                  >
